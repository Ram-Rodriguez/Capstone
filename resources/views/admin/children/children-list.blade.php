              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <form action="{{ route('children.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to archive this assignment? You may unarchive this in the archived assignments page.')">
                    @csrf
                    @method('PUT')
