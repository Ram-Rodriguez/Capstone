  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('head.logout') }}" role="button" onclick="return confirm('Are you sure you want to logout?')">Log out<i class="fas fa-right-from-bracket"></i></a>
        </li>
      </ul>
    </nav>
