              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $item->doa }}</td>
                    <td><a href="{{ route('head.children.show', $item->id) }}" class="btn btn-primary">Show</a></td>
                    <td><a href="{{ route('head.children.edit', $item->id) }}" class="btn btn-primary">Edit</a></td>
                    <form action="{{ route('head.children.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to archive this record? You may unarchive this in the archived records page.')">
                    @csrf
                    @method('PUT')
