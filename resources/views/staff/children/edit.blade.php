            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('staff.children.update', $children->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="blood_type" class="form-control">
                                            <option value="A+" {{ ( $children->blood_type == "A+") ? 'selected' : '' }}>A+</option>
                                            <option value="A-" {{ ( $children->blood_type == "A-") ? 'selected' : '' }}>A-</option>
                                            <option value="B+" {{ ( $children->blood_type == "B+") ? 'selected' : '' }}>B+</option>
                                            <option value="B-" {{ ( $children->blood_type == "A-") ? 'selected' : '' }}>B-</option>
                                            <option value="AB+" {{ ( $children->blood_type == "AB+") ? 'selected' : '' }}>AB+</option>
                                            <option value="AB-" {{ ( $children->blood_type == "AB-") ? 'selected' : '' }}>AB-</option>
                                            <option value="O+" {{ ( $children->blood_type == "O+") ? 'selected' : '' }}>O+</option>
                                            <option value="O-" {{ ( $children->blood_type == "O+") ? 'selected' : '' }}>O-</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->csf != null)
                                            <a href="{{ route('staff.download.csf', $children->id) }}">Download Existing File</a>
                                        @endif
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->poe != null)
                                            <a href="{{ route('staff.download.poe', $children->id) }}">Download Existing File</a>
                                        @endif
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->cof != null)
                                            <a href="{{ route('staff.download.cof', $children->id) }}">Download Existing File</a>
                                        @endif
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->cola != null)
                                            <a href="{{ route('staff.download.cola', $children->id) }}">Download Existing File</a>
                                        @endif
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->cfsc != null)
                                            <a href="{{ route('staff.download.cfsc', $children->id) }}">Download Existing File</a>
                                        @endif
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->bc != null)
                                            <a href="{{ route('staff.download.bc', $children->id) }}">Download Existing File</a>
                                        @endif
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->admission_photo != null)
                                            <a href="{{ route('staff.download.admission_photo', $children->id) }}">Download Existing File</a>
                                        @endif
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        @if($children->latest_photo != null)
                                            <a href="{{ route('staff.download.latest_photo', $children->id) }}">Download Existing File</a>
                                        @endif
